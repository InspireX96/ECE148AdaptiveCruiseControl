...
echo "Copying parts"
cd parts && cp lidar_distance_calculator.py lidar_filters.py lidar_processor.py cruise_controller.py yolo_processor.py ~/projects/donkeycar/donkeycar/parts
